...
int main() {
    ...
    statusManager.addParameter(Parameter::SOC, "LOW_SOC_WARNING", 21, 24, {
    ...
    statusManager.addParameter(Parameter::SOC, "HIGH_SOC_WARNING", 76, 80, {
        {Language::ENGLISH, "State of Charge approaching high limit!"},
        {Language::GERMAN, "Ladezustand nähert sich dem hohen Limit!"}
    });
    statusManager.addParameter(Parameter::SOC, "HIGH_SOC_BREACH", 81, 100, {
        {Language::ENGLISH, "State of Charge too high!"},
        {Language::GERMAN, "Ladezustand zu hoch!"}
    });

    statusManager.addParameter(Parameter::TEMPERATURE, "LOW_TEMP_BREACH", -10, 0, {
        {Language::ENGLISH, "Temperature too low!"},
        {Language::GERMAN, "Temperatur zu niedrig!"}
    });
    statusManager.addParameter(Parameter::TEMPERATURE, "LOW_TEMP_WARNING", 1, 10, {
    ...
    statusManager.addParameter(Parameter::TEMPERATURE, "HIGH_TEMP_WARNING", 41, 45, {
        {Language::ENGLISH, "Temperature approaching high limit!"},
        {Language::GERMAN, "Temperatur nähert sich dem hohen Limit!"}
    });
    statusManager.addParameter(Parameter::TEMPERATURE, "HIGH_TEMP_BREACH", 46, 50, {
        {Language::ENGLISH, "Temperature too high!"},
        {Language::GERMAN, "Temperatur zu hoch!"}
    });

    statusManager.addParameter(Parameter::CHARGE_RATE, "NORMAL", 0, 0.7, {
        {Language::ENGLISH, "Charge Rate normal."},
        {Language::GERMAN, "Laderate normal."}
    });
    statusManager.addParameter(Parameter::CHARGE_RATE, "HIGH_CHARGE_RATE_WARNING", 0.71, 0.8, {
        {Language::ENGLISH, "Charge Rate approaching high limit!"},
        {Language::GERMAN, "Laderate nähert sich dem hohen Limit!"}
    });
    statusManager.addParameter(Parameter::CHARGE_RATE, "HIGH_CHARGE_RATE_BREACH", 0.81, 1.0, {
